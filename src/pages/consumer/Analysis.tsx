        ...
        <div className="flex-1 flex flex-col">
          ...
          <main className="flex-1 p-6">
            <div className="max-w-6xl mx-auto">
              <div className="mb-6">
                <h1 className="font-display text-2xl text-foreground mb-2">Property Analysis</h1>
                <p className="text-muted-foreground">
                  AI-powered insights including neighborhood analysis, crime rates, and building perks
                </p>
              </div>
