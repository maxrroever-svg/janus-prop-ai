  ...
  return (
    <SidebarProvider>
      ...
      <div className="flex-1 flex flex-col min-h-screen">
        <DashboardHeader title="Janus Deal Feed" subtitle="AI-curated investment opportunities ranked by potential" />
            ...
            {deals.length === 0 ? (
              ...
              <>
                ...
                <div className="absolute bottom-20 left-1/2 transform -translate-x-1/2 z-50">
                  <div className="dashboard-card rounded-lg px-4 py-2">
                    <div className="text-foreground text-sm flex items-center space-x-2 font-medium">
                ...
                {isLoading && (
                  <div className="absolute bottom-32 left-1/2 transform -translate-x-1/2 z-50">
                    <div className="dashboard-card rounded-full px-6 py-3">
                      <div className="text-foreground text-sm flex items-center space-x-3">
