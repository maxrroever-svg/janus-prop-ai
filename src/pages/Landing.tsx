  ...
  <main>
    ...
    <section id="home" class="section">
      <div class="container reveal">
        ...
        <div class="actions" style="margin-top:12px">
          <a class="glass" href="/consumer" onclick="event.preventDefault(); window.location.assign('/consumer');" rel="external" style="padding:.7rem 1.1rem; border-radius:999px; border:1px solid var(--hair)">Enter Consumer Dashboard</a>
          <a class="glass" href="/investor" onclick="event.preventDefault(); window.location.assign('/investor');" rel="external" style="padding:.7rem 1.1rem; border-radius:999px; border:1px solid var(--hair)">Enter Investor Dashboard</a>
        </div>
      </div>
    </section>
    ...
    <section id="consumer" class="band">
      ...
      <div class="container band-content reveal">
        ...
        <div class="actions"><a class="cta glass" href="/consumer" onclick="event.preventDefault(); window.location.assign('/consumer');" rel="external">Enter Dashboard</a></div>
      </div>
    </section>
    ...
    <section id="investor" class="band">
      ...
      <div class="container band-content reveal">
        ...
        <div class="actions">
          <a class="cta glass" href="/investor" onclick="event.preventDefault(); window.location.assign('/investor');" rel="external">Enter Dashboard</a>
        </div>
      </div>
    </section>
