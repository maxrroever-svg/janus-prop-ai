  ...
  <main>
    ...
    <section id="home" class="section">
      <div class="container reveal">
        ...
        <div class="actions" style="margin-top:12px">
          ...
          <a class="glass" href="/investor" style="padding:.7rem 1.1rem; border-radius:999px; border:1px solid var(--hair)">Enter Investor Dashboard</a>
        </div>
      </div>
    </section>
    ...
    <section id="investor" class="band">
      ...
      <div class="container band-content reveal">
        ...
        <div class="actions">
          <a class="cta glass" href="/investor">Enter Dashboard</a>
        </div>
      </div>
    </section>
